...
\[
    \kappa(t) = \frac{\|\drvec \times \vec r \;''(t)\|}{\|\drvec\|^3} \\
\]
\begin{align*}
    Let \; \vec r \;'(t) &= 2\sqrt 6t \ihat + 2\jaht + 6t^2\khat \\
...
\begin{vmatrix}
    ...
    2\sqrt 6t & 2 & 6t^2 \\
    2\sqrt 6 & 0 & 12t
    \end{vmatrix} = \ihat \begin{vmatrix} 2t & 6t^2 \\ 0 & 12t \end{vmatrix} - \jhat \begin{vmatrix} 2\sqrt 6t & 6t^2 \\ 2\sqrt 6 & 12t \end{vmatrix} + \khat \begin{vmatrix} 2\sqrt 6t & 2 \\ 2\sqrt 6 & 0 \end{vmatrix} \\ 
                                             &= (24t^2 - 0)\ihat - (24t^2\sqrt{6} - 12t^2\sqrt{6})\jhat + (0 - 4\sqrt 6)\khat = 24t^2\ihat - 12t^2\sqrt 6\jhat - 4\sqrt 6\khat \\
\begin{align*}
    \kappa(t) &= \frac{\|\drvec \times \vec r \;''(t)\|}{\|\drvec\|^3} \\
\end{align*}
