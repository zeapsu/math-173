...
\begin{align*}
    ...
    -4 & 0 \\\\
    0 & 6,-6 \\
\end{vmatrix} = -24 - 0 = -24,\qquad 24-0 = 24\\
    H_f(1, \pm 1) &= det\begin{vmatrix}
    8 & 0 \\\\
    0 & 6,-6 \\
\end{vmatrix} = 48 - 0 = 48,\qquad -48-0 = -48\\
    H_f(-1, \pm 1) &= det\begin{vmatrix}
    8 & 0 \\\\
    0 & 6,-6 \\
\end{vmatrix} = 48 - 0 = 48,\qquad -48-0 = -48\\
...
\end{align*}
\begin{align*}
    0 &= 2y - 2\cos x  \qquad[\text{y = 0}] \\
    0 &= - 2\cos x \\
    x &= \frac \pi 2\also \frac {3\pi} 2 \\\\
    0 &= 2y - 2\cos x  \qquad[\text{x = 0}] \\
    0 &= 2y - 2 \\
    y &= 1 \\\\
    0 &= 2y - 2\cos x  \qquad[\text{x = $\pi$}] \\
    0 &= 2y + 2 \\
    y &= -1 \\\\
    0 &= 2y - 2\cos x  \qquad[\text{x = 2$\pi$}] \\
    0 &= 2y - 2 \\
    y &= 1
\end{align*}
\newpage
